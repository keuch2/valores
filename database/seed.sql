...
INSERT INTO servicios (titulo, slug, icono, descripcion_corta, orden, activo) VALUES
  ...
  ('Gestión profesional de inversiones', 'gestion-profesional-de-inversiones', 'fa-chart-pie', 'Análisis y selección de instrumentos, diversificación del portafolio y seguimiento de su evolución según el perfil y los objetivos de cada cliente.', 6, 1),
